...
#Defines Instruction length of device
set DEF_IL	12
...
#-----------------------------------------------------------------------------
proc setup_rdbk_cmd {argFrameCount} {
  global DEF_CMD
  global DEF_WPF
...
#-----------------------------------------------------------------------------
proc rdbk_jtag {argfile_log_name argFrameCount argOverwrite} {
  ...
  set sTmpVar [setup_rdbk_cmd $argFrameCount]
...
#  scan_ir_hw_jtag 6 -tdi $DEF_JCONFIG
  scan_ir_hw_jtag $DEF_IL -tdi $DEF_JCONFIG
...
#  scan_ir_hw_jtag 6 -tdi $DEF_JRDBK
  scan_ir_hw_jtag $DEF_IL -tdi $DEF_JRDBK
...
#  scan_ir_hw_jtag 6 -tdi $DEF_BYPASS
  scan_ir_hw_jtag $DEF_IL -tdi $DEF_BYPASS
